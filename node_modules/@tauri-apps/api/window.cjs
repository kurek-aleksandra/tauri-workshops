...
class Window {
    ...
    async onCloseRequested(handler) {
        return this.listen(event.TauriEvent.WINDOW_CLOSE_REQUESTED, (event) => {
    ...
    async onDragDropEvent(handler) {
        const unlistenDrag = await this.listen(event.TauriEvent.DRAG, (event) => {
            handler({
                ...event,
                payload: {
                    type: 'dragged',
        ...
        const unlistenDrop = await this.listen(event.TauriEvent.DROP, (event) => {
            handler({
                ...event,
                payload: {
                    type: 'dropped',
        ...
        const unlistenDragOver = await this.listen(event.TauriEvent.DROP_OVER, (event) => {
            handler({
                ...event,
                payload: {
                    type: 'dragOver',
        ...
        const unlistenCancel = await this.listen(event.TauriEvent.DROP_CANCELLED, (event) => {
